              ...
              <div class="flex-1  justify-between flex flex-col h-96 w-80">
                ...
                <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
                  <div class="relative flex">
                    <input :disabled="isLoading" type="text" placeholder="Escribe un mensaje..." v-model="newMessage.text"
                      v-on:keyup.enter="sendMessage(newMessage.text) " id="message-input"
